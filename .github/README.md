...
[`@aws-sdk/client-timestream-query`](https://www.npmjs.com/package/@aws-sdk/client-timestream-query/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2Egil0+l1f3x/BkSxDkbKFRYbBTehRq/msXoCfTxpRquG/ybVpFQ+VBy7SB3Eqee
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-timestream-query": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.991.0/index.min.mjs": "sha384-2Egil0+l1f3x/BkSxDkbKFRYbBTehRq/msXoCfTxpRquG/ybVpFQ+VBy7SB3Eqee"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-timestream-query/blob/refs/tags/3.991.0/LICENSE
```
