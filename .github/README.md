...
[`@aws-sdk/client-timestream-query`](https://www.npmjs.com/package/@aws-sdk/client-timestream-query/v/3.1115.0).
...
- @aws-sdk/client-timestream-query v3.1115.0 - [https://cloud-sdk-builds.github.io/?sdk=client-timestream-query&version=3.1115.0](https://cloud-sdk-builds.github.io/?sdk=client-timestream-query&version=3.1115.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.1115.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ifzjGmPH8mGRILgdO+PZzyPW0mw+4Th0nHFWgmVZ4C0gNeImyE8wvtpusgG6ueAE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-timestream-query": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.1115.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.1115.0/index.min.mjs": "sha384-ifzjGmPH8mGRILgdO+PZzyPW0mw+4Th0nHFWgmVZ4C0gNeImyE8wvtpusgG6ueAE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-timestream-query/blob/refs/tags/3.1115.0/LICENSE
```
