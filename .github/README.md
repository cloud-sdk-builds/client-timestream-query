...
[`@aws-sdk/client-timestream-query`](https://www.npmjs.com/package/@aws-sdk/client-timestream-query/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p0l9u81SOyUUPAFhi0EBxAEiVEwPcvGRY0OAXFfGpzrlZ0n8fROsLCpOCr+T2p4d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-timestream-query": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.631.0/index.min.mjs": "sha384-p0l9u81SOyUUPAFhi0EBxAEiVEwPcvGRY0OAXFfGpzrlZ0n8fROsLCpOCr+T2p4d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-timestream-query/blob/refs/tags/3.631.0/LICENSE
```
