...
[`@aws-sdk/client-timestream-query`](https://www.npmjs.com/package/@aws-sdk/client-timestream-query/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fF/a+FTwPh6FyVN1tE5/tYVYvw3+VSiO5vNyP5Pc0+clKbhP5G88jD98Qx/hRiKE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-timestream-query": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-query@3.168.0/index.min.mjs": "sha384-fF/a+FTwPh6FyVN1tE5/tYVYvw3+VSiO5vNyP5Pc0+clKbhP5G88jD98Qx/hRiKE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-timestream-query/blob/refs/tags/3.168.0/LICENSE
```
